...
package body Coms_Uart is
   ...
   ----------------------------------------------------------------------------
   -- Same constants and subprograms as before...
   ----------------------------------------------------------------------------
   ...
   begin
      if CMD = "LED ON" then
         Turn_On (Green_LED);
         Send_String_Newline ("Green LED Turned ON");
      elsif CMD = "LED OFF" then
         Turn_Off (Green_LED);
         Send_String_Newline ("Green LED Turned OFF");
      else
         Send_String_Newline ("ERR: Invalid command");
      end if;
   end Process_Command;
