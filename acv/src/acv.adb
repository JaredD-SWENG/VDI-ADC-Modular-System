...
package body Acv is
   ...
   function Black_And_White (Img : Image_T; Threshold : Intensity_T) return Image_T is
   ...
   begin
      for Y in Img'Range(2) loop
         for X in Img'Range(1) loop
            ...
            Result(X, Y) := (if Gray < Threshold then (0, 0, 0) else (255, 255, 255));
         end loop;
      end loop;
      return Result;
   end Black_And_White;
   ...
   function Raw_Img_Data (Directory : String; File_Name : String) return Storage_Array is
      use OS;
   ...
   function Qoi_Desc (Directory : String; File_Name : String) return Qoi.QOI_Desc is
   ...
   begin
      ...
      declare
         Out_Len     : constant Storage_Count := Desc.Width * Desc.Height * Desc.Channels;
         Output      : Storage_Array (0 .. Out_Len - 1);
         Img         : Image_T (0 .. Integer (Desc.Width) - 1, 1 .. Integer (Desc.Height) - 1) 
                              with Address => Output'Address;
   ...
   procedure To_Qoi (Img : Image_T; Directory : String; File_Name : String) is
   begin
      null;
   end To_Qoi;
