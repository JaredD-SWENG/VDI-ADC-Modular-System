...
package body GUI_Functions is
   ...
   begin
      ...
      On_Key_Press_Event(Gtk_Widget (Get_Object (Builder, "topWindow")), GUI_Functions.KeyPressed'Access);
      On_Key_Press_Event(Gtk_Widget (Get_Object (Builder, "rawWindow")), GUI_Functions.KeyPressed'Access);
