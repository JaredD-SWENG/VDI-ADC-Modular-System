            ...
            select
               ...
               if Queue_Manager.Is_Empty then
                  ...
                  if Current_Event.all in Signal_State'Class then
                     ...
                     begin
                        Put_Line("Processing Event: Signal State - " & 
                                Signal_Color'Image(Signal.Color));
                        case Signal.Color is
                           when Red => Put_Line("Path Planning: Stop");
                           when Yellow => Put_Line("Path Planning: Slow");
                           when Green => Put_Line("Path Planning: Go");
                        end case;
                     end;
                     ...
                     begin
                        Put_Line("Processing Event: Offset - Value: " & 
