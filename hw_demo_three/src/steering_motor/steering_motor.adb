...
package body Steering_Motor is
   ...
   protected body Steering_Controller is
   ...
   begin
      ...
      procedure Set_Angle(Degrees : Commands.Angle_Degrees) is
      begin
         Steering_Impl.Set_Angle(Degrees);
      end Set_Angle;

      procedure Center is
      begin
         Steering_Impl.Center;
      end Center;

      function Current_Angle return Integer is
      begin
         return Steering_Impl.Get_Angle;
      end Current_Angle;
   ...
   begin
      This.Enable;
         if offset >= -1.0 and then offset <= 1.0 then
